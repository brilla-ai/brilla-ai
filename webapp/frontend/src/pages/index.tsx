      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className={"mt-6 text-lg leading-8 "}>
            ...
            {
              "The goal of nsmqai is to build an AI to compete live in the NSMQ competition and win — performing better than the best contestants in all rounds and stages of the competition."
            }
          </p>
        </div>
      </main>
