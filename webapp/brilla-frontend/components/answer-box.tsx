...
const AnswerBox = () => {
  ...
  const lastMessageRef = useRef<HTMLDivElement | null>(null); // Specify the type for the ref
  ...
  const handleIconClick = () => {
    const textInput = document?.getElementById("textInput") as HTMLTextAreaElement; // Cast to HTMLTextAreaElement
